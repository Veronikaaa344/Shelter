...
const TASKS = [
    { text: "Знайдіть 5 предметів навколо", icon: "👁️", color: "from-blue-500/20 to-indigo-500/20", border: "border-blue-500/30" },
    { text: "Торкніться 4 різних текстур", icon: "🤲", color: "from-purple-500/20 to-pink-500/20", border: "border-purple-500/30" },
    { text: "Почуйте 3 різні звуки", icon: "👂", color: "from-emerald-500/20 to-teal-500/20", border: "border-emerald-500/30" },
    { text: "Відчуйте 2 різні запахи", icon: "🌿", color: "from-amber-500/20 to-orange-500/20", border: "border-amber-500/30" },
    { text: "Відчуйте 1 смак", icon: "✨", color: "from-rose-500/20 to-red-500/20", border: "border-rose-500/30" },
];
    ...
    return (
        <div className="fixed inset-0 bg-[#070a12] flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="z-10 flex flex-col items-center gap-8 max-w-lg w-full px-8 animate-in fade-in duration-500">
                ...
                >
                    <div className="text-8xl mb-8 animate-in zoom-in duration-500">{task.icon}</div>
